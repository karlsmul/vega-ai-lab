...
**Warum jetzt:** Google is pitching an AI agent ecosystem to consumers who may not buy it (TechCrunch AI); With aluminum prices up 20%, recycling startups bet on AI to cash in (TechCrunch AI); Clouted wants to take the guesswork out of making short videos go viral (TechCrunch AI)
...
- https://techcrunch.com/2026/05/21/with-aluminum-prices-up-20-recycling-startups-bet-on-ai-to-cash-in
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Fine-Tuning NVIDIA Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation (Hugging Face Blog); The Path, founded by Tony Robbins and Calm alums, hopes to offer safer AI therapy (TechCrunch AI)
