...
**Warum jetzt:** How NVIDIA engineers and researchers build with Codex (OpenAI Blog); What Parameter Golf taught us about AI-assisted research (OpenAI Blog); 5 gardening tips you can try right in Search (Google AI Blog)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Databricks brings GPT-5.5 to enterprise agent workflows (OpenAI Blog); How sales teams use Codex (OpenAI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); Databricks brings GPT-5.5 to enterprise agent workflows (OpenAI Blog)
...
**Warum jetzt:** How business operations teams use Codex (OpenAI Blog); How sales teams use Codex (OpenAI Blog); Adding Benchmaxxer Repellant to the Open ASR Leaderboard (Hugging Face Blog)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); The new AI-powered Google Finance is expanding to Europe. (Google AI Blog); See what happens when creative legends use AI to make ads for small businesses. (Google AI Blog)
...
**Warum jetzt:** Databricks brings GPT-5.5 to enterprise agent workflows (OpenAI Blog); Sea's View on the Future of Agentic Software Development with Codex (OpenAI Blog); Building a safe, effective sandbox to enable Codex on Windows (OpenAI Blog)
...
**Warum jetzt:** Reduce friction and latency for long-running jobs with Webhooks in Gemini API (Google AI Blog); The OpenAI trial wraps up, and the Musk founder machine keeps spinning (TechCrunch AI); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Osaurus brings both local and cloud AI models to your Mac (TechCrunch AI); Show HN: Botais (Battle of the AI's) – Competitive Snake Game for LLMs (HackerNews AI)
...
**Warum jetzt:** How sales teams use Codex (OpenAI Blog); Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
