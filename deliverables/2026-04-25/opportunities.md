...
**Warum jetzt:** Pi.ai LLM Outperforms Palm/GPT3.5 (HackerNews AI); Show HN: AI Timeline – 171 LLMs from Transformer (2017) to GPT-5.3 (2026) (HackerNews AI); microsoft/onnxruntime (GitHub Trending AI)
...
**Warum jetzt:** QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); DeepSeek previews new AI model that ‘closes the gap’ with frontier models (TechCrunch AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Introducing OpenAI Privacy Filter (OpenAI Blog); Marked-up Mac minis flood eBay amid shortages driven by AI (TechCrunch AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); DeepSeek previews new AI model that ‘closes the gap’ with frontier models (TechCrunch AI); Meet Noscroll, an AI bot that does your doomscrolling for you (TechCrunch AI)
...
**Warum jetzt:** Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); ComfyUI hits $500M valuation as creators seek more control over AI-generated media (TechCrunch AI); huggingface/transformers (GitHub Trending AI)
