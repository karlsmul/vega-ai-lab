...
**Warum jetzt:** Introducing ChatGPT Futures: Class of 2026 (OpenAI Blog); How frontier enterprises are building an AI advantage (OpenAI Blog); 5 gardening tips you can try right in Search (Google AI Blog)
...
**Warum jetzt:** How frontier enterprises are building an AI advantage (OpenAI Blog); OpenAI and PwC collaborate to reimagine the office of the CFO (OpenAI Blog); Join the new AI Agents Vibe Coding Course from Google and Kaggle (Google AI Blog)
...
**Warum jetzt:** How frontier enterprises are building an AI advantage (OpenAI Blog); OpenAI and PwC collaborate to reimagine the office of the CFO (OpenAI Blog); Study: Firms often use automation to control certain workers’ wages (MIT AI News)
...
**Warum jetzt:** Adding Benchmaxxer Repellant to the Open ASR Leaderboard (Hugging Face Blog); QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); At TechCrunch Disrupt 2026, all your M&A questions will be answered (TechCrunch AI)
...
**Warum jetzt:** Uber uses OpenAI to help people earn smarter and book faster (OpenAI Blog); Singular Bank helps bankers move fast with ChatGPT and Codex (OpenAI Blog); How OpenAI delivers low-latency voice AI at scale (OpenAI Blog)
...
**Warum jetzt:** Reduce friction and latency for long-running jobs with Webhooks in Gemini API (Google AI Blog); Q&A: MIT SHASS and the future of education in the age of AI (MIT AI News); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Khosla-backed robotics startup Genesis AI has gone full stack, demo shows (TechCrunch AI); Show HN: Botais (Battle of the AI's) – Competitive Snake Game for LLMs (HackerNews AI)
