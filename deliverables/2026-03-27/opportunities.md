...
**Warum jetzt:** Equipping workers with insights about compensation (OpenAI Blog); Search Live is expanding globally (Google AI Blog); Bringing the power of Personal Intelligence to more people (Google AI Blog)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); GGML and llama.cpp join HF to ensure the long-term progress of Local AI (Hugging Face Blog); Cohere launches an open source voice model specifically for transcription (TechCrunch AI)
...
**Warum jetzt:** Mistral releases a new open source model for speech generation (TechCrunch AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
...
**Warum jetzt:** Gemini 3.1 Flash Live: Making audio AI more natural and reliable (Google AI Blog); A New Framework for Evaluating Voice Agents (EVA) (Hugging Face Blog); Cohere launches an open source voice model specifically for transcription (TechCrunch AI)
