...
**Warum jetzt:** Advancing youth safety and opportunity through global leadership (OpenAI Blog); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); OpenAI launches new Codex tools for white-collar work (TechCrunch AI)
...
**Warum jetzt:** How Endava builds an agentic organization with Codex (OpenAI Blog); I/O 2026: Welcome to the agentic Gemini era (Google AI Blog); Holo3.1: Fast & Local Computer Use Agents (Hugging Face Blog)
...
**Warum jetzt:** Strengthening societal resilience with Rosalind Biodefense (OpenAI Blog); Microsoft offers devs a better way to control AI agent behavior (TechCrunch AI); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Show HN: Botais (Battle of the AI's) – Competitive Snake Game for LLMs (HackerNews AI)
...
**Warum jetzt:** A new experiment brings better group meetings to Google Beam (Google AI Blog); New ways to create and get things done in Google Workspace (Google AI Blog); Martin Scorsese becomes the latest — and most unlikely — Hollywood voice for AI (TechCrunch AI)
