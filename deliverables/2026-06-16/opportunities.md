...
**Warum jetzt:** 5 ways Google Search can level up your thrift and vintage shopping (Google AI Blog); How AI Mode is changing the way people search in the U.S. (Google AI Blog); SpaceX is public: Everything you need to know post-IPO (TechCrunch AI)
...
**Warum jetzt:** New OpenAI Academy courses for the next era of work (OpenAI Blog); OpenAI to acquire Ona (OpenAI Blog); How an Agent Built a 3D Paris Gallery by Chaining Two Hugging Face Spaces (Hugging Face Blog)
...
**Warum jetzt:** New OpenAI Academy courses for the next era of work (OpenAI Blog); OpenAI to acquire Ona (OpenAI Blog); Salesforce acquires AI customer service platform Fin for $3.6B (TechCrunch AI)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Salesforce acquires AI customer service platform Fin for $3.6B (TechCrunch AI); As Anthropic suspends access to new models, India debates its AI future (TechCrunch AI)
