...
## Validation: AI Sales Micro-SaaS

### Zielkunden

**Primär:** SDRs

**Sekundär:** Freelancer mit Outreach-Bedarf, kleine Sales-Teams (2-5 Personen)
...
- **A1** [🔴 KRITISCH]: Das Problem "Sales-Teams versenden generische Nachrichten die ignoriert werden — Personalisie..." existiert und ist schmerzhaft genug, dass Leute dafür zahlen.
- **A2** [🔴 KRITISCH]: SDRs, Freelancer mit Outreach-Bedarf, kleine Sales-Teams (2-5 Personen) sind erreichbar und haben Budget für 39-79€/Monat.
- **A3** [🔴 KRITISCH]: Die vorgeschlagene Lösung löst das Problem besser als der aktuelle Workaround.
...
#### T1: Problem-Interview
- **Was:** Führe 5 Gespräche mit SDRs, Freelancer mit Outreach-Bedarf, kleine Sales-Teams (2-5 Personen). Frage: "Wie löst du aktuell [Problem]?" und "Was stört dich am meisten?"
- **Erfolg wenn:** ≥3 von 5 beschreiben das Problem als Top-3 Pain Point
- **Aufwand:** 2-3 Stunden
- **Testet:** A1
