...
**Warum jetzt:** GGML and llama.cpp join HF to ensure the long-term progress of Local AI (Hugging Face Blog); Delve accused of misleading customers with ‘fake compliance’ (TechCrunch AI); SharpAI/DeepCamera (GitHub Trending AI)
...
**Warum jetzt:** Delve accused of misleading customers with ‘fake compliance’ (TechCrunch AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
