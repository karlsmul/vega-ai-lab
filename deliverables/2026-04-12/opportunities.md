...
**Warum jetzt:** ChatGPT for marketing teams (OpenAI Blog); Writing with ChatGPT (OpenAI Blog); Prompting fundamentals (OpenAI Blog)
...
**Warum jetzt:** Using custom GPTs (OpenAI Blog); Using skills (OpenAI Blog); ChatGPT for operations teams (OpenAI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); Our response to the Axios developer tool compromise (OpenAI Blog)
