...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); UFund-Me/Qbot (GitHub Trending AI)
...
**Warum jetzt:** Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI); PostHog/posthog (GitHub Trending AI); Show HN: Beta Launch Announcement: AI-Powered Tool for Web Developers – Sign Up (HackerNews Show AI)
