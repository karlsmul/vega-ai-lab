...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Choco automates food distribution with AI agents (OpenAI Blog); What is Codex? (OpenAI Blog)
...
**Warum jetzt:** QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); Salesforce is crowdsourcing its AI roadmap — with customers  (TechCrunch AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); How to build scalable web apps with OpenAI's Privacy Filter (Hugging Face Blog); Enabling privacy-preserving AI training on everyday devices (MIT AI News)
...
**Warum jetzt:** Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog); pyannote/pyannote-audio (GitHub Trending AI)
