...
**Warum jetzt:** Research with ChatGPT (OpenAI Blog); Working with files in ChatGPT (OpenAI Blog); ChatGPT for sales teams (OpenAI Blog)
...
**Warum jetzt:** Applications of AI at OpenAI (OpenAI Blog); New ways to balance cost and reliability in the Gemini API (Google AI Blog); Build with Veo 3.1 Lite, our most cost-effective video generation model (Google AI Blog)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Using custom GPTs (OpenAI Blog); ChatGPT for sales teams (OpenAI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); Research with ChatGPT (OpenAI Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Transform your headphones into a live personal translator on iOS. (Google AI Blog); TechCrunch is heading to Tokyo — and bringing the Startup Battlefield with it (TechCrunch AI)
...
**Warum jetzt:** langchain-ai/langchain (GitHub Trending AI); ALTK‑Evolve: On‑the‑Job Learning for AI Agents (Hugging Face Blog); A New Framework for Evaluating Voice Agents (EVA) (Hugging Face Blog)
...
**Warum jetzt:** Writing with ChatGPT (OpenAI Blog); Getting started with ChatGPT (OpenAI Blog); Working with files in ChatGPT (OpenAI Blog)
...
**Warum jetzt:** ChatGPT for sales teams (OpenAI Blog); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
