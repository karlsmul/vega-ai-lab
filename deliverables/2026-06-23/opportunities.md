...
**Warum jetzt:** A near-autonomous AI chemist improves a challenging reaction in medicinal chemistry (OpenAI Blog); New OpenAI Academy courses for the next era of work (OpenAI Blog); MosaicLeaks: Can your research agent keep a secret? (Hugging Face Blog)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); New OpenAI Academy courses for the next era of work (OpenAI Blog); activepieces/activepieces (GitHub Trending AI)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); MIT in the media: For the future of tech, "Massachusetts can absolutely lead" (MIT AI News); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Our new community investments in Virginia support local jobs and expand energy affordability. (Google AI Blog); We got local models to triage the OpenClaw repo for FREE!* (Hugging Face Blog)
...
**Warum jetzt:** Nemotron 3.5 Content Safety: Customizable Multimodal Safety for Global Enterprise AI (Hugging Face Blog); Ask HN: Who are your favourite AI content creators? (HackerNews AI)
...
**Warum jetzt:** New chip could help tiny robots traverse complex environments (MIT AI News); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI)
