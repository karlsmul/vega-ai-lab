...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); OpenAI and Dell partner to bring Codex to hybrid and on-premise enterprise environments (OpenAI Blog); Databricks brings GPT-5.5 to enterprise agent workflows (OpenAI Blog)
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Introducing OpenAI for Singapore (OpenAI Blog); OpenAI and Dell partner to bring Codex to hybrid and on-premise enterprise environments (OpenAI Blog)
...
**Warum jetzt:** Reduce friction and latency for long-running jobs with Webhooks in Gemini API (Google AI Blog); With Gemini 3.5 Flash, Google bets its next AI wave on agents, not chatbots (TechCrunch AI); Agentic app coding gets an upgrade with Google’s release of Android CLI (TechCrunch AI)
...
- https://techcrunch.com/2026/05/19/agentic-app-coding-gets-an-upgrade-with-googles-release-of-android-cli
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Fine-Tuning NVIDIA Cosmos Predict 2.5 with LoRA/DoRA for Robot Video Generation (Hugging Face Blog); Google’s Genie world model can now simulate real streets with Street View (TechCrunch AI)
...
**Warum jetzt:** How sales teams use Codex (OpenAI Blog); New ways to create and get things done in Google Workspace (Google AI Blog); Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog)
