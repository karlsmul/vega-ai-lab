...
**Warum jetzt:** Introducing North Mini Code: Cohere’s First Model For Developers (Hugging Face Blog); Designing the hf CLI as an agent-optimized way to work with the Hub (Hugging Face Blog); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI)
