...
**Warum jetzt:** Rakuten fixes issues twice as fast with Codex (OpenAI Blog); Designing AI agents to resist prompt injection (OpenAI Blog); Introducing Modular Diffusers - Composable Building Blocks for Diffusion Pipelines (Hugging Face Blog)
...
**Warum jetzt:** Introducing the OpenAI Safety Bug Bounty program (OpenAI Blog); Powering product discovery in ChatGPT (OpenAI Blog); How we monitor internal coding agents for misalignment (OpenAI Blog)
...
**Warum jetzt:** run-llama/llama_index (GitHub Trending AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
...
**Warum jetzt:** Creating with Sora Safely (OpenAI Blog); Designing AI agents to resist prompt injection (OpenAI Blog); Bluesky leans into AI with Attie, an app for building custom feeds (TechCrunch AI)
