...
**Warum jetzt:** OpenAI to acquire Ona (OpenAI Blog); How Endava is redesigning software delivery around AI agents (OpenAI Blog); Jeff Bezos’s Prometheus raises $12B to build an ‘artificial general engineer’ for the physical world (TechCrunch AI)
...
**Warum jetzt:** OpenAI to acquire Ona (OpenAI Blog); How Endava is redesigning software delivery around AI agents (OpenAI Blog); I/O 2026: Welcome to the agentic Gemini era (Google AI Blog)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Anthropic’s Dario Amodei has just one direct report (TechCrunch AI); cvat-ai/cvat (GitHub Trending AI)
...
**Warum jetzt:** Supporting Europe’s work in ensuring a trustworthy AI ecosystem  (OpenAI Blog); Nemotron 3.5 Content Safety: Customizable Multimodal Safety for Global Enterprise AI (Hugging Face Blog); Pool’s new app turns your screenshots into something useful (TechCrunch AI)
...
**Warum jetzt:** Our new community investments in Virginia support local jobs and expand energy affordability. (Google AI Blog); Holo3.1: Fast & Local Computer Use Agents (Hugging Face Blog); Reachy Mini goes fully local (Hugging Face Blog)
