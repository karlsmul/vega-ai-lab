...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Codex for (almost) everything (OpenAI Blog); Introducing GPT-Rosalind for life sciences research (OpenAI Blog)
...
**Warum jetzt:** The next evolution of the Agents SDK (OpenAI Blog); Enterprises power agentic workflows in Cloudflare Agent Cloud with OpenAI (OpenAI Blog); Inside VAKRA: Reasoning, Tool Use, and Failure Modes of Agents (Hugging Face Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Transform your headphones into a live personal translator on iOS. (Google AI Blog); Physical Intelligence, a hot robotics startup, says its new robot brain can figure out tasks it was never taught (TechCrunch AI)
...
**Warum jetzt:** Accelerating the cyber defense ecosystem that protects us all (OpenAI Blog); ChatGPT for sales teams (OpenAI Blog); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
...
**Warum jetzt:** Getting started with ChatGPT (OpenAI Blog); ChatGPT for managers (OpenAI Blog); Ask HN: Who are your favourite AI content creators? (HackerNews AI)
...
**Warum jetzt:** Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); Gemini 3.1 Flash Live: Making audio AI more natural and reliable (Google AI Blog); A New Framework for Evaluating Voice Agents (EVA) (Hugging Face Blog)
