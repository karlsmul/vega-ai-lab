...
**Warum jetzt:** OpenRouter more than doubles valuation to $1.3B in a year (TechCrunch AI); What ClickUp’s mass layoff tells us about the future of work (TechCrunch AI); The pope’s AI encyclical isn’t really about AI (TechCrunch AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); This startup is betting India’s gig economy can train the world’s robots (TechCrunch AI)
...
**Warum jetzt:** OpenAI, Grupo Folha and Grupo UOL announce strategic content partnership (OpenAI Blog); Advancing content provenance for a safer, more transparent AI ecosystem (OpenAI Blog); Universal Music Group and TikTok renew agreement to combat unauthorized AI music (TechCrunch AI)
