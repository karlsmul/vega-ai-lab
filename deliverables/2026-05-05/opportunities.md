...
**Warum jetzt:** Introducing GPT-5.5 (OpenAI Blog); Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog); Elon Musk’s only AI expert witness at the OpenAI trial fears an AGI arms race (TechCrunch AI)
...
**Warum jetzt:** QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); The best AI dictation apps, tested and ranked (TechCrunch AI); invoke-ai/InvokeAI (GitHub Trending AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); AI evals are becoming the new compute bottleneck (Hugging Face Blog); Image AI models now drive app growth, beating chatbot upgrades (TechCrunch AI)
