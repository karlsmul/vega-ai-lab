...
**Warum jetzt:** Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI); servo/servo (GitHub Trending AI); PostHog/posthog (GitHub Trending AI)
