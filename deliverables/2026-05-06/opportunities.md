...
**Warum jetzt:** Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog); Meta will use AI to analyze height and bone structure to identify if users are underage (TechCrunch AI); Beacon Biosignals is mapping the brain during sleep (MIT AI News)
...
**Warum jetzt:** OpenAI available at FedRAMP Moderate (OpenAI Blog); Choco automates food distribution with AI agents (OpenAI Blog); Reduce friction and latency for long-running jobs with Webhooks in Gemini API (Google AI Blog)
...
**Warum jetzt:** OpenAI and PwC collaborate to reimagine the office of the CFO (OpenAI Blog); OpenAI models, Codex, and Managed Agents come to AWS (OpenAI Blog); An open-source spec for orchestration: Symphony (OpenAI Blog)
...
**Warum jetzt:** OpenAI and PwC collaborate to reimagine the office of the CFO (OpenAI Blog); Choco automates food distribution with AI agents (OpenAI Blog); Turn your best AI prompts into one-click tools in Chrome (Google AI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); Introducing Advanced Account Security (OpenAI Blog)
...
**Warum jetzt:** New ways to buy ChatGPT ads (OpenAI Blog); How to build scalable web apps with OpenAI's Privacy Filter (Hugging Face Blog); Enabling privacy-preserving AI training on everyday devices (MIT AI News)
...
**Warum jetzt:** How OpenAI delivers low-latency voice AI at scale (OpenAI Blog); Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Marc Lore says that AI will soon enable anyone open a restaurant (TechCrunch AI); Pennsylvania sues Character.AI after a chatbot allegedly posed as a doctor (TechCrunch AI)
