...
**Warum jetzt:** Gradient Labs gives every bank customer an AI account manager (OpenAI Blog); AUTOMATIC1111/stable-diffusion-webui (GitHub Trending AI); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
...
**Warum jetzt:** Google quietly launched an AI dictation app that works offline (TechCrunch AI); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
