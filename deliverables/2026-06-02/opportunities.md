...
**Warum jetzt:** Codex is becoming a productivity tool for everyone (OpenAI Blog); OpenAI frontier models and Codex are now available on AWS (OpenAI Blog); MUFG aims to become AI-native with OpenAI (OpenAI Blog)
...
**Warum jetzt:** Codex is becoming a productivity tool for everyone (OpenAI Blog); How AI Mode is changing the way people search in the U.S. (Google AI Blog); A new era for AI Search (Google AI Blog)
...
**Warum jetzt:** Strengthening societal resilience with Rosalind Biodefense (OpenAI Blog); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI); servo/servo (GitHub Trending AI)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
