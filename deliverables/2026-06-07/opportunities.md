...
**Warum jetzt:** How Endava is redesigning software delivery around AI agents (OpenAI Blog); I/O 2026: Welcome to the agentic Gemini era (Google AI Blog); Designing the hf CLI as an agent-optimized way to work with the Hub (Hugging Face Blog)
...
**Warum jetzt:** Designing the hf CLI as an agent-optimized way to work with the Hub (Hugging Face Blog); Sriram Krishnan is leaving his role as White House AI advisor (TechCrunch AI); Defense tech, AI, and fundraising take center stage at StrictlyVC Los Angeles on June 18 (TechCrunch AI)
