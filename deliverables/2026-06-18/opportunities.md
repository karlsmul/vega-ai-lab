...
**Warum jetzt:** A near-autonomous AI chemist improves a challenging reaction in medicinal chemistry (OpenAI Blog); Introducing LifeSciBench (OpenAI Blog); New research shows how AMIE, our medical AI, could help manage health conditions. (Google AI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); Predicting model behavior before release by simulating deployment (OpenAI Blog)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Roelof Botha joins SpaceX’s board of directors (TechCrunch AI); NEA’s Tiffany Luck says enterprises are still figuring out their AI ROI (TechCrunch AI)
...
**Warum jetzt:** New OpenAI Academy courses for the next era of work (OpenAI Blog); OpenAI to acquire Ona (OpenAI Blog); microsoft/qlib (GitHub Trending AI)
...
**Warum jetzt:** Designing the hf CLI as an agent-optimized way to work with the Hub (Hugging Face Blog); Roelof Botha joins SpaceX’s board of directors (TechCrunch AI); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI)
...
**Warum jetzt:** Supporting Europe’s work in ensuring a trustworthy AI ecosystem  (OpenAI Blog); Nemotron 3.5 Content Safety: Customizable Multimodal Safety for Global Enterprise AI (Hugging Face Blog); How to turn off AI in your Google Docs (TechCrunch AI)
...
**Warum jetzt:** Our new community investments in Virginia support local jobs and expand energy affordability. (Google AI Blog); Holo3.1: Fast & Local Computer Use Agents (Hugging Face Blog); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
