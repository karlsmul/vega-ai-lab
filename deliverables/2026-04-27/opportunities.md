...
**Warum jetzt:** Plugins and skills (OpenAI Blog); What is Codex? (OpenAI Blog); Automations (OpenAI Blog)
...
**Warum jetzt:** PostHog/posthog (GitHub Trending AI); Making ChatGPT better for clinicians (OpenAI Blog); Speeding up agentic workflows with WebSockets in the Responses API (OpenAI Blog)
...
**Warum jetzt:** Introducing GPT-5.5 (OpenAI Blog); Making ChatGPT better for clinicians (OpenAI Blog); MIT scientists build the world’s largest collection of Olympiad-level math problems, and open it to everyone (MIT AI News)
...
**Warum jetzt:** Speeding up agentic workflows with WebSockets in the Responses API (OpenAI Blog); Introducing workspace agents in ChatGPT (OpenAI Blog); Workspace agents (OpenAI Blog)
...
**Warum jetzt:** Marked-up Mac minis flood eBay amid shortages driven by AI (TechCrunch AI); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
