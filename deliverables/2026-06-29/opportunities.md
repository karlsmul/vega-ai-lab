...
**Warum jetzt:** Mapping Europe’s AI Workforce Opportunity (OpenAI Blog); Improving the speed and energy-efficiency of AI agents (MIT AI News); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
...
**Warum jetzt:** A new experiment brings better group meetings to Google Beam (Google AI Blog); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI); Show HN: Superpowered (YC W21) – The AI copilot for your meetings (HackerNews Show AI)
