...
**Warum jetzt:** microsoft/qlib (GitHub Trending AI); STADLER reshapes knowledge work at a 230-year-old company (OpenAI Blog); Search Live is expanding globally (Google AI Blog)
...
**Warum jetzt:** Pi.ai LLM Outperforms Palm/GPT3.5 (HackerNews AI); Show HN: AI Timeline – 171 LLMs from Transformer (2017) to GPT-5.3 (2026) (HackerNews AI); microsoft/qlib (GitHub Trending AI)
...
**Warum jetzt:** Helping developers build safer AI experiences for teens (OpenAI Blog); OpenAI to acquire Astral (OpenAI Blog); New ways to balance cost and reliability in the Gemini API (Google AI Blog)
...
**Warum jetzt:** microsoft/qlib (GitHub Trending AI); Gradient Labs gives every bank customer an AI account manager (OpenAI Blog); Introducing the OpenAI Safety Bug Bounty program (OpenAI Blog)
...
**Warum jetzt:** microsoft/qlib (GitHub Trending AI); Gradient Labs gives every bank customer an AI account manager (OpenAI Blog); baserow/baserow (GitHub Trending AI)
...
**Warum jetzt:** Less than a month: StrictlyVC San Francisco brings leaders from TDK Ventures, Replit, and more together (TechCrunch AI); Salesforce announces an AI-heavy makeover for Slack, with 30 new features (TechCrunch AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
...
**Warum jetzt:** Gemini 3.1 Flash Live: Making audio AI more natural and reliable (Google AI Blog); A New Framework for Evaluating Voice Agents (EVA) (Hugging Face Blog); OpenAI acquires TBPN, the buzzy founder-led business talk show (TechCrunch AI)
...
**Warum jetzt:** baserow/baserow (GitHub Trending AI); khoj-ai/khoj (GitHub Trending AI); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
