...
**Warum jetzt:** Automations (OpenAI Blog); Top 10 uses for Codex at work (OpenAI Blog); Plugins and skills (OpenAI Blog)
...
**Warum jetzt:** Workspace agents (OpenAI Blog); Speeding up agentic workflows with WebSockets in the Responses API (OpenAI Blog); Introducing workspace agents in ChatGPT (OpenAI Blog)
...
**Warum jetzt:** QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); DeepSeek previews new AI model that ‘closes the gap’ with frontier models (TechCrunch AI); run-llama/llama_index (GitHub Trending AI)
...
**Warum jetzt:** Introducing OpenAI Privacy Filter (OpenAI Blog); Marked-up Mac minis flood eBay amid shortages driven by AI (TechCrunch AI); chidiwilliams/buzz (GitHub Trending AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Anthropic created a test marketplace for agent-on-agent commerce (TechCrunch AI); DeepSeek previews new AI model that ‘closes the gap’ with frontier models (TechCrunch AI)
...
**Warum jetzt:** Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); ComfyUI hits $500M valuation as creators seek more control over AI-generated media (TechCrunch AI); chidiwilliams/buzz (GitHub Trending AI)
