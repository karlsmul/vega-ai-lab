...
**Warum jetzt:** GGML and llama.cpp join HF to ensure the long-term progress of Local AI (Hugging Face Blog); Delve accused of misleading customers with ‘fake compliance’ (TechCrunch AI); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
...
**Warum jetzt:** Create new worlds in Project Genie with these 4 tips (Google AI Blog); WordPress.com now lets AI agents write and publish posts, and more (TechCrunch AI); Ask HN: Who are your favourite AI content creators? (HackerNews AI)
