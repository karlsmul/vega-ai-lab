...
**Warum jetzt:** Choco automates food distribution with AI agents (OpenAI Blog); What is Codex? (OpenAI Blog); Codex settings (OpenAI Blog)
...
**Warum jetzt:** QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); Otter’s new feature lets users search across their enterprise tools (TechCrunch AI); cvat-ai/cvat (GitHub Trending AI)
...
**Warum jetzt:** Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog); Amazon launches an AI-powered audio Q&A experience on product pages (TechCrunch AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Otter’s new feature lets users search across their enterprise tools (TechCrunch AI); Show HN: Botais (Battle of the AI's) – Competitive Snake Game for LLMs (HackerNews AI)
