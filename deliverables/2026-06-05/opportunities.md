...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); How Endava is redesigning software delivery around AI agents (OpenAI Blog); Introducing new capabilities to GPT-Rosalind (OpenAI Blog)
...
- https://techcrunch.com/2026/06/04/apple-touts-1-4-trillion-in-app-store-billings-and-sales-90-without-a-commission
...
**Warum jetzt:** How Endava is redesigning software delivery around AI agents (OpenAI Blog); I/O 2026: Welcome to the agentic Gemini era (Google AI Blog); Apple approves Poke as the first AI agent on its Messages for Business platform (TechCrunch AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Is Silicon Valley ready to put robots in people’s homes? Hello Robot is. (TechCrunch AI)
...
**Warum jetzt:** A new experiment brings better group meetings to Google Beam (Google AI Blog); New ways to create and get things done in Google Workspace (Google AI Blog); These two founders left Goldman and Meta to build voice AI for markets everyone else overlooked (TechCrunch AI)
...
**Warum jetzt:** Codex is becoming a productivity tool for everyone (OpenAI Blog); Ask HN: Who are your favourite AI content creators? (HackerNews AI)
