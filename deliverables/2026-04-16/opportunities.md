...
**Warum jetzt:** Enterprises power agentic workflows in Cloudflare Agent Cloud with OpenAI (OpenAI Blog); Using custom GPTs (OpenAI Blog); Turn your best AI prompts into one-click tools in Chrome (Google AI Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Transform your headphones into a live personal translator on iOS. (Google AI Blog); India’s vibe-coding startup Emergent enters OpenClaw-like AI agent space (TechCrunch AI)
...
**Warum jetzt:** Prompting fundamentals (OpenAI Blog); Working with files in ChatGPT (OpenAI Blog); Getting started with ChatGPT (OpenAI Blog)
...
**Warum jetzt:** Google rolls out a native Gemini app for Mac (TechCrunch AI); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
