...
**Warum jetzt:** 5 ways Google Search can level up your thrift and vintage shopping (Google AI Blog); How AI Mode is changing the way people search in the U.S. (Google AI Blog); SpaceX IPO: Live updates on everything you need to know (TechCrunch AI)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); As Anthropic suspends access to new models, India debates its AI future (TechCrunch AI); SpaceX, Anthropic, and OpenAI’s hot IPO summer (TechCrunch AI)
...
**Warum jetzt:** Supporting Europe’s work in ensuring a trustworthy AI ecosystem  (OpenAI Blog); Nemotron 3.5 Content Safety: Customizable Multimodal Safety for Global Enterprise AI (Hugging Face Blog); Anthropic’s safety warnings may have just backfired — the government has pulled the plug on its most powerful AI (TechCrunch AI)
...
**Warum jetzt:** New OpenAI Academy courses for the next era of work (OpenAI Blog); OpenAI to acquire Ona (OpenAI Blog); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
