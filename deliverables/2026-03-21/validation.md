...
## Validation: AI Knowledge Bot Platform

### Zielkunden

**Primär:** HR-Leads

**Sekundär:** Support-Teamleiter, Ops-Manager in 10-100 Personen Unternehmen
...
- **A1** [🔴 KRITISCH]: Das Problem "Teams beantworten dieselben internen Fragen immer wieder — Wissen ist in Docs ve..." existiert und ist schmerzhaft genug, dass Leute dafür zahlen.
- **A2** [🔴 KRITISCH]: HR-Leads, Support-Teamleiter, Ops-Manager in 10-100 Personen Unternehmen sind erreichbar und haben Budget für 49-99€/Monat.
- **A3** [🔴 KRITISCH]: Die vorgeschlagene Lösung löst das Problem besser als der aktuelle Workaround.
...
#### T1: Problem-Interview
- **Was:** Führe 5 Gespräche mit HR-Leads, Support-Teamleiter, Ops-Manager in 10-100 Personen Unternehmen. Frage: "Wie löst du aktuell [Problem]?" und "Was stört dich am meisten?"
- **Erfolg wenn:** ≥3 von 5 beschreiben das Problem als Top-3 Pain Point
- **Aufwand:** 2-3 Stunden
- **Testet:** A1
