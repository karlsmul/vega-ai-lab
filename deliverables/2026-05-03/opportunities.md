...
**Warum jetzt:** QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); The best AI dictation apps, tested and ranked (TechCrunch AI); Did you know you can’t steal a charity? Don’t worry. Elon Musk will remind you. (TechCrunch AI)
...
**Warum jetzt:** Choco automates food distribution with AI agents (OpenAI Blog); What is Codex? (OpenAI Blog); Turn your best AI prompts into one-click tools in Chrome (Google AI Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); AI evals are becoming the new compute bottleneck (Hugging Face Blog); Meta buys robotics startup to bolster its humanoid AI ambitions (TechCrunch AI)
...
**Warum jetzt:** Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); Introducing NVIDIA Nemotron 3 Nano Omni: Long-Context Multimodal Intelligence for Documents, Audio and Video Agents (Hugging Face Blog); The best AI dictation apps, tested and ranked (TechCrunch AI)
