...
**Warum jetzt:** What Parameter Golf taught us about AI-assisted research (OpenAI Blog); How NVIDIA engineers and researchers build with Codex (OpenAI Blog); 5 gardening tips you can try right in Search (Google AI Blog)
...
**Warum jetzt:** How sales teams use Codex (OpenAI Blog); Databricks brings GPT-5.5 to enterprise agent workflows (OpenAI Blog); AutoScout24 scales engineering with AI-powered workflows (OpenAI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); How data science teams use Codex (OpenAI Blog)
...
**Warum jetzt:** How sales teams use Codex (OpenAI Blog); How business operations teams use Codex (OpenAI Blog); Adding Benchmaxxer Repellant to the Open ASR Leaderboard (Hugging Face Blog)
...
**Warum jetzt:** The new AI-powered Google Finance is expanding to Europe. (Google AI Blog); See what happens when creative legends use AI to make ads for small businesses. (Google AI Blog); How to build scalable web apps with OpenAI's Privacy Filter (Hugging Face Blog)
