...
**Warum jetzt:** pathwaycom/pathway (GitHub Trending AI); Rakuten fixes issues twice as fast with Codex (OpenAI Blog); Designing AI agents to resist prompt injection (OpenAI Blog)
...
**Warum jetzt:** Create new worlds in Project Genie with these 4 tips (Google AI Blog); Meta rolls out new AI content enforcement systems while reducing reliance on third-party vendors (TechCrunch AI); Sam Altman’s thank-you to coders draws the memes (TechCrunch AI)
...
**Warum jetzt:** The Gemini-powered features in Google Workspace that are worth using (TechCrunch AI); The leaderboard “you can’t game,” funded by the companies it ranks (TechCrunch AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
...
**Warum jetzt:** How Descript enables multilingual video dubbing at scale (OpenAI Blog); Granite 4.0 1B Speech: Compact, Multilingual, and Built for the Edge (Hugging Face Blog); Rebel Audio is a new AI podcasting tool aimed at first-time creators  (TechCrunch AI)
