...
**Warum jetzt:** 5 ways Google Search can level up your thrift and vintage shopping (Google AI Blog); How AI Mode is changing the way people search in the U.S. (Google AI Blog); Sixty percent of US consumers say ‘AI’ in brand messaging is a turnoff, survey finds (TechCrunch AI)
...
**Warum jetzt:** New OpenAI Academy courses for the next era of work (OpenAI Blog); OpenAI to acquire Ona (OpenAI Blog); From the Hugging Face Hub to robot hardware with Strands Agents and LeRobot (Hugging Face Blog)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Anthropic’s latest feud with the Trump admin may actually help it, sales data suggests (TechCrunch AI); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI)
...
**Warum jetzt:** Designing the hf CLI as an agent-optimized way to work with the Hub (Hugging Face Blog); Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI); openai/openai-cookbook (GitHub Trending AI)
