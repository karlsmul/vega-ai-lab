...
**Warum jetzt:** Rakuten fixes issues twice as fast with Codex (OpenAI Blog); Introducing Modular Diffusers - Composable Building Blocks for Diffusion Pipelines (Hugging Face Blog); ScaleOps raises $130M to improve computing efficiency amid AI demand (TechCrunch AI)
...
**Warum jetzt:** Create new worlds in Project Genie with these 4 tips (Google AI Blog); Ask HN: Who are your favourite AI content creators? (HackerNews AI)
