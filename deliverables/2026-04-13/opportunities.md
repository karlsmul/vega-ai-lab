...
**Warum jetzt:** Working with files in ChatGPT (OpenAI Blog); Research with ChatGPT (OpenAI Blog); Search Live is expanding globally (Google AI Blog)
...
**Warum jetzt:** New ways to balance cost and reliability in the Gemini API (Google AI Blog); Build with Veo 3.1 Lite, our most cost-effective video generation model (Google AI Blog); Build with Lyria 3, our newest music generation model (Google AI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); Working with files in ChatGPT (OpenAI Blog)
...
**Warum jetzt:** Using custom GPTs (OpenAI Blog); ChatGPT for operations teams (OpenAI Blog); Using skills (OpenAI Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Transform your headphones into a live personal translator on iOS. (Google AI Blog); Sam Altman responds to ‘incendiary’ New Yorker article after attack on his home (TechCrunch AI)
...
**Warum jetzt:** ALTK‑Evolve: On‑the‑Job Learning for AI Agents (Hugging Face Blog); A New Framework for Evaluating Voice Agents (EVA) (Hugging Face Blog); TechCrunch is heading to Tokyo — and bringing the Startup Battlefield with it (TechCrunch AI)
