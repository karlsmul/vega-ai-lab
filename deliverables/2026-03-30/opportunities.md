...
**Warum jetzt:** Rakuten fixes issues twice as fast with Codex (OpenAI Blog); Introducing Modular Diffusers - Composable Building Blocks for Diffusion Pipelines (Hugging Face Blog); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
