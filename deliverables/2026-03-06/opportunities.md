...
**Warum jetzt:** khoj-ai/khoj (GitHub Trending AI); Introducing GPT-5.4 (OpenAI Blog); Introducing ChatGPT for Excel and new financial data integrations (OpenAI Blog)
...
**Warum jetzt:** khoj-ai/khoj (GitHub Trending AI); How Axios uses AI to help deliver high-impact local journalism  (OpenAI Blog); Introducing the Stateful Runtime Environment for Agents in Amazon Bedrock (OpenAI Blog)
...
**Warum jetzt:** khoj-ai/khoj (GitHub Trending AI); How Axios uses AI to help deliver high-impact local journalism  (OpenAI Blog); GGML and llama.cpp join HF to ensure the long-term progress of Local AI (Hugging Face Blog)
...
**Warum jetzt:** khoj-ai/khoj (GitHub Trending AI); Introducing the Stateful Runtime Environment for Agents in Amazon Bedrock (OpenAI Blog); IBM and UC Berkeley Diagnose Why Enterprise Agents Fail Using IT-Bench and MAST (Hugging Face Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Bringing Robotics AI to Embedded Platforms: Dataset Recording, VLA Fine‑Tuning, and On‑Device Optimizations (Hugging Face Blog); Cursor is rolling out a new kind of agentic coding tool (TechCrunch AI)
...
**Warum jetzt:** Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI); PostHog/posthog (GitHub Trending AI); Show HN: Cape API – Keep your sensitive data private while using GPT-4 (HackerNews AI)
