...
**Warum jetzt:** Making ChatGPT better for clinicians (OpenAI Blog); Introducing GPT-Rosalind for life sciences research (OpenAI Blog); Granite 4.0 3B Vision: Compact Multimodal Intelligence for Enterprise Documents (Hugging Face Blog)
...
**Warum jetzt:** Making ChatGPT better for clinicians (OpenAI Blog); Speeding up agentic workflows with WebSockets in the Responses API (OpenAI Blog); Codex for (almost) everything (OpenAI Blog)
...
**Warum jetzt:** langchain-ai/langchain (GitHub Trending AI); Introducing workspace agents in ChatGPT (OpenAI Blog); Speeding up agentic workflows with WebSockets in the Responses API (OpenAI Blog)
...
**Warum jetzt:** Accelerating the cyber defense ecosystem that protects us all (OpenAI Blog); QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); AI Overviews are coming to your Gmail at work (TechCrunch AI)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); Google turns Chrome into an AI co-worker for the workplace (TechCrunch AI)
...
**Warum jetzt:** Introducing OpenAI Privacy Filter (OpenAI Blog); baserow/baserow (GitHub Trending AI); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Transform your headphones into a live personal translator on iOS. (Google AI Blog); Show HN: Botais (Battle of the AI's) – Competitive Snake Game for LLMs (HackerNews AI)
...
**Warum jetzt:** Q&A: MIT SHASS and the future of education in the age of AI (MIT AI News); A philosophy of work (MIT AI News); baserow/baserow (GitHub Trending AI)
