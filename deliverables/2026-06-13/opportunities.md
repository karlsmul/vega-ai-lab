...
**Warum jetzt:** Introducing the OpenAI Economic Research Exchange (OpenAI Blog); 5 ways Google Search can level up your thrift and vintage shopping (Google AI Blog); How AI Mode is changing the way people search in the U.S. (Google AI Blog)
...
**Warum jetzt:** New OpenAI Academy courses for the next era of work (OpenAI Blog); OpenAI to acquire Ona (OpenAI Blog); Jeff Bezos’s Prometheus raises $12B to build an ‘artificial general engineer’ for the physical world (TechCrunch AI)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); SpaceX, Anthropic, and OpenAI’s hot IPO summer (TechCrunch AI); It’s hot IPO summer, and the MANGOS are ripe (TechCrunch AI)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); PRC-linked influence operations are targeting AI debates in the US (OpenAI Blog)
...
**Warum jetzt:** Supporting Europe’s work in ensuring a trustworthy AI ecosystem  (OpenAI Blog); Anthropic’s safety warnings may have just backfired — the government has pulled the plug on its most powerful AI (TechCrunch AI); Pool’s new app turns your screenshots into something useful (TechCrunch AI)
...
**Warum jetzt:** New OpenAI Academy courses for the next era of work (OpenAI Blog); OpenAI to acquire Ona (OpenAI Blog); I/O 2026: Welcome to the agentic Gemini era (Google AI Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Theker just raised $85M to build the factory robot that doesn’t specialize in anything (TechCrunch AI)
...
**Warum jetzt:** Show HN: Natural Language to SQL "Text-to-SQL" API (HackerNews AI); cvat-ai/cvat (GitHub Trending AI)
...
**Warum jetzt:** What Codex unlocks for Notion (OpenAI Blog); A new experiment brings better group meetings to Google Beam (Google AI Blog); New ways to create and get things done in Google Workspace (Google AI Blog)
