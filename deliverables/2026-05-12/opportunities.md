...
**Warum jetzt:** Scaling Trusted Access for Cyber with GPT-5.5 and GPT-5.5-Cyber (OpenAI Blog); Parloa builds service agents customers want to talk to (OpenAI Blog); How frontier firms are pulling ahead (OpenAI Blog)
...
**Warum jetzt:** Adding Benchmaxxer Repellant to the Open ASR Leaderboard (Hugging Face Blog); QIMMA قِمّة ⛰: A Quality-First Arabic LLM Leaderboard (Hugging Face Blog); Digg tries again, this time as an AI news aggregator (TechCrunch AI)
...
**Warum jetzt:** Advancing voice intelligence with new models in the API (OpenAI Blog); Reduce friction and latency for long-running jobs with Webhooks in Gemini API (Google AI Blog); Q&A: MIT SHASS and the future of education in the age of AI (MIT AI News)
