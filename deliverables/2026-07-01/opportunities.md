...
**Warum jetzt:** Introducing GeneBench-Pro (OpenAI Blog); How agents are transforming work (OpenAI Blog); How GPT-5 helped immunologist Derya Unutmaz solve a 3-year-old mystery (OpenAI Blog)
...
**Warum jetzt:** Pi.ai LLM Outperforms Palm/GPT3.5 (HackerNews AI); Show HN: AI Timeline – 171 LLMs from Transformer (2017) to GPT-5.3 (2026) (HackerNews AI); Introducing GeneBench-Pro (OpenAI Blog)
...
**Warum jetzt:** Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); Introducing the FFASR Leaderboard: Benchmarking ASR in the Real World (Hugging Face Blog); Nvidia competitor Etched hits $5B valuation, $1B in sales for AI chip (TechCrunch AI)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Core dump epidemiology: fixing an 18-year-old bug (OpenAI Blog); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog)
...
**Warum jetzt:** Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers); How ChatGPT adoption has expanded (OpenAI Blog)
...
**Warum jetzt:** How agents are transforming work (OpenAI Blog); ScarfBench: Benchmarking AI Agents for Enterprise Java Framework Migration (Hugging Face Blog); MosaicLeaks: Can your research agent keep a secret? (Hugging Face Blog)
...
**Warum jetzt:** Experimenting with the proposed Cross-Origin Storage API in Transformers.js (Hugging Face Blog); X now offers an MCP server to make its platform easier for AI tools to use (TechCrunch AI); Q&A: What is agentic AI today, and what do we want it to be? (MIT AI News)
...
**Warum jetzt:** Mapping Europe’s AI Workforce Opportunity (OpenAI Blog); Anthropic’s Claude Science bets on workflow, not a new model, to win over scientists (TechCrunch AI); Improving the speed and energy-efficiency of AI agents (MIT AI News)
...
**Warum jetzt:** Our new community investments in Virginia support local jobs and expand energy affordability. (Google AI Blog); We got local models to triage the OpenClaw repo for FREE!* (Hugging Face Blog); Lumo, Proton’s privacy-focused AI chatbot, gets an upgrade (TechCrunch AI)
...
**Warum jetzt:** Google introduces a faster, cheaper image generator with Nano Banana 2 Lite (TechCrunch AI); Podcasting platform Riverside enters the newsletter publishing game (TechCrunch AI); Ask HN: Who are your favourite AI content creators? (HackerNews AI)
