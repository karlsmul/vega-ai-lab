...
**Warum jetzt:** openai/whisper (GitHub Trending AI); How sales teams use Codex (OpenAI Blog); A new experiment brings better group meetings to Google Beam (Google AI Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Catch up on the Dialogues stage at Google I/O 2026. (Google AI Blog); The Path, founded by Tony Robbins and Calm alums, hopes to offer safer AI therapy (TechCrunch AI)
...
**Warum jetzt:** Advancing content provenance for a safer, more transparent AI ecosystem (OpenAI Blog); Ask HN: Who are your favourite AI content creators? (HackerNews AI)
