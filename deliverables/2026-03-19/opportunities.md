...
**Warum jetzt:** pathwaycom/pathway (GitHub Trending AI); Equipping workers with insights about compensation (OpenAI Blog); Codex Security: now in research preview  (OpenAI Blog)
...
**Warum jetzt:** pathwaycom/pathway (GitHub Trending AI); n8n-io/n8n (GitHub Trending AI); Rakuten fixes issues twice as fast with Codex (OpenAI Blog)
...
**Warum jetzt:** pathwaycom/pathway (GitHub Trending AI); Launch HN: Patterns (YC S21) – A much faster way to build and deploy data apps (IndieHackers); Launch HN: Lume (YC W23) – Generate custom data integrations with AI (IndieHackers)
...
**Warum jetzt:** Introducing GPT-5.4 mini and nano (OpenAI Blog); From model to agent: Equipping the Responses API with a computer environment  (OpenAI Blog); Rebel Audio is a new AI podcasting tool aimed at first-time creators  (TechCrunch AI)
...
**Warum jetzt:** Create new worlds in Project Genie with these 4 tips (Google AI Blog); Sam Altman’s thank-you to coders draws the memes (TechCrunch AI); Patreon CEO calls AI companies’ fair use argument ‘bogus,’ says creators should be paid (TechCrunch AI)
...
**Warum jetzt:** The Gemini-powered features in Google Workspace that are worth using (TechCrunch AI); The leaderboard “you can’t game,” funded by the companies it ranks (TechCrunch AI); The PhD students who became the judges of the AI industry (TechCrunch AI)
...
- https://techcrunch.com/podcast/the-phd-students-who-became-the-judges-of-the-ai-industry
...
**Warum jetzt:** n8n-io/n8n (GitHub Trending AI); Nemotron 3 Nano 4B: A Compact Hybrid Model for Efficient Local AI (Hugging Face Blog); GGML and llama.cpp join HF to ensure the long-term progress of Local AI (Hugging Face Blog)
