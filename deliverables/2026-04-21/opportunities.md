...
**Warum jetzt:** Introducing GPT-Rosalind for life sciences research (OpenAI Blog); ChatGPT for research (OpenAI Blog); Search Live is expanding globally (Google AI Blog)
...
**Warum jetzt:** The Bing AI bot has been secretly running GPT-4 (HackerNews AI); Transform your headphones into a live personal translator on iOS. (Google AI Blog); Google rolls out Gemini in Chrome in 7 new countries (TechCrunch AI)
...
**Warum jetzt:** Prompting fundamentals (OpenAI Blog); Getting started with ChatGPT (OpenAI Blog); Writing with ChatGPT (OpenAI Blog)
...
**Warum jetzt:** Accelerating the cyber defense ecosystem that protects us all (OpenAI Blog); Show HN: Voice AI is wild now. I vibe coded this email agent in 24 hours (HackerNews AI); Show HN: Drafting AI – Human-in-the-loop AI automation for ops teams' email (IndieHackers)
...
**Warum jetzt:** Gemini 3.1 Flash TTS: the next generation of expressive AI speech (Google AI Blog); Gemini 3.1 Flash Live: Making audio AI more natural and reliable (Google AI Blog); ggml-org/whisper.cpp (GitHub Trending AI)
