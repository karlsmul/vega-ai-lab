...
**Warum jetzt:** Powering product discovery in ChatGPT (OpenAI Blog); How we monitor internal coding agents for misalignment (OpenAI Blog); Introducing GPT-5.4 mini and nano (OpenAI Blog)
...
**Warum jetzt:** GGML and llama.cpp join HF to ensure the long-term progress of Local AI (Hugging Face Blog); Talat’s AI meeting notes stay on your machine, not in the cloud (TechCrunch AI); Show HN: Omnifact – Self-Hosted, Privacy-First AI Platform for Enterprise (IndieHackers)
...
**Warum jetzt:** Creating with Sora Safely (OpenAI Blog); Designing AI agents to resist prompt injection (OpenAI Blog); OpenAI’s Sora was the creepiest app on your phone — now it’s shutting down (TechCrunch AI)
...
**Warum jetzt:** A New Framework for Evaluating Voice Agents (EVA) (Hugging Face Blog); OpenAI’s Sora was the creepiest app on your phone — now it’s shutting down (TechCrunch AI); Talat’s AI meeting notes stay on your machine, not in the cloud (TechCrunch AI)
